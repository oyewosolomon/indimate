...
export const serviceData: Service[] = [
  {
    title: "Full Planning",
    backgroundImage: "/assets/images/services/full-planning.webp",
    featureImage: "/assets/images/services/full-planning.webp",
    content: [
  ...
  },
  {
    ...
    backgroundImage: "/assets/images/services/full-decoration.webp",
    featureImage: "/assets/images/services/full-decoration.webp",
    content: [
  ...
  },
  {
    ...
    backgroundImage: "/assets/images/portfolio/middle-east/parasol-desert-arch.webp",
    featureImage: "/assets/images/portfolio/africa/garden-aisle-walk.webp",
    content: [
...
export const processData: Service[] = [
  {
    ...
    backgroundImage: "/assets/images/portfolio/africa/white-arch-portrait.webp",
    featureImage: "/assets/images/portfolio/europe/four-poster-bed-portrait.webp",
    content: [
  ...
  },
  {
    ...
    backgroundImage: "/assets/images/services/vendor-selection.webp",
    featureImage: "/assets/images/services/vendor-selection.webp",
    content: [
  ...
  },
  {
    ...
    backgroundImage: "/assets/images/services/event-management.webp",
    featureImage: "/assets/images/services/event-management.webp",
    content: [
